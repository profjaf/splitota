...
tachodat = zeros(Np,1); %angle data
ft(1:t0/Tstep) = F0;
freqHz=5;
theta=0;
thetaM=zeros(Np,1);
...
Res2(:,13) = tachodat;
Res2(:,14) = thetaM;
pathFolderResults = [pwd,'\input\timeDataPlateOTA2.txt'];
%pathFolderResults = [pwd,'\input\timeDataPlateOTANoF.txt'];
