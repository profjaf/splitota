...
rm=[500;500;500]; %VKF weighting factor, 
rmSplit=[2 2 2];
...
%      Np=2000;
    ...
    bp=fix(2000/bsize);
    plot(blktime(Nst:bsize:Nend),abs(FRFOrder(Nst:bsize:Nend,1)),'-bs','LineWidth',1,'MarkerEdgeColor','b', 'MarkerSize',4,'MarkerIndices',1:bp:endplot);ylim([2 max(1.1*abs(FRFOrder(Nst:bsize:Nend,1,1)))]);
    hold on
